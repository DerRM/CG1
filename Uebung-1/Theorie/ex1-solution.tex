...
Während des Renderings stehen 2 Framebuffer zur Verfügung. Das heißte es kann in 2 Buffer geschrieben werden um Bildinformationen zu speichern. Während der Inhalt des ersten Buffers auf dem Display angezeigt wird, wird in dem 2. Buffer der nächste Frame gerendert. Anschließend werden beide Buffer vertauscht. Dies ermöglicht flüssiges Anzeigen von Bewegungen und Animationen, da die benötigten Informationen zeitnah zur Verfügung stehen. Am Beispiel der Übung lässt sich der Roboter ruckelfrei hin- und herbewegen.
